// Frontend block properties (mirrors backend definition).
...
export function isSolid(id) { return BlockProps[id]?.solid ?? false; }
export function isTransparent(id) { return BlockProps[id]?.transparent ?? true; }
export function isBreakable(id) { return id !== Block.AIR && id !== Block.BEDROCK; }
